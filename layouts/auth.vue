        ...
        <v-row>
          ...
          >
            <ul class="featured-wrapper">
              ...
              <li class="featured-wrapper__phrase">Diviértete</li>
            </ul>
          </v-col>
          <nuxt />
          <v-col
          ...
          >
            <ul class="featured-wrapper">
              ...
              <li class="featured-wrapper__phrase">
                Diversión y pasión en un club exclusivo
              </li>
...
import iconGems from '@/assets/ui-icon-gems.svg'
